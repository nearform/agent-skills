...
function generateMarkdown(
  ...
  md += `> generating, or refactoring Node.js and Fastify applications. Humans  \n`
  ...
  try {
    ...
    try {
      ...
      metadata = {
        ...
        abstract:
          'Performance, security, and reliability guide for Node.js and Fastify applications, ordered by impact.',
      }
    }
